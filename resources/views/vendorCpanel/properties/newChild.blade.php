...
@php
    $breadcrumb = ['Dashboard', 'Properties', 'Add New Child property'];
                ...
                <div class="content">
                    <div class="container-fluid">
                        <form action="{{ route('property.new.post') }}" method="POST">
                            ...
                            <input type="hidden" name="propertyTypeI" value="child">
                            @if ($property)
                                <input type="hidden" name="propertyParentI" value="{{$property->id}}">
                            @endif
                            {{ csrf_field() }}
